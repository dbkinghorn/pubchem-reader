...
class ns0:
    ...
    class GetAssayDescription_Dec(ZSI.TCcompound.ComplexType, ElementDeclaration):
        ...
        def __init__(self, **kw):
            ...
            TClist = [ZSI.TCnumbers.Iint(pname=(ns,"AID"), aname="_AID", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.Boolean(pname=(ns,"GetVersion"), aname="_GetVersion", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded"))]
